...
//		System.out.println(map.show());
		...
		//
		// SimpleHashMap<Integer, Integer> map = new SimpleHashMap<Integer,
		// Integer>(
		// 9);
...
//		 map.put(18, 18);
		...
		// SimpleHashMap<Integer, Integer> map2 = new SimpleHashMap<Integer,
		// Integer>(
		// 9);
		// map2.put(1, 1);
		...
		// System.out.println(random); HashSet<Integer> randNbrs2 = new
		// HashSet<Integer>(); for (int i = 0; i < 1000; i++) { int r =
		// random.nextInt(10000); map2.put(r, r); randNbrs2.add(r);
		// System.out.println("Added value: " + map2.get(r)); }
		// System.out.println(map2.show()); for (int i : randNbrs2) {
		// System.out.println("Värde som tas bort: " + i + " " +
		// map2.remove(i));
		// }
		//
		//
