...
public class AddMenu extends JMenuItem implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		 ...
		 gui.setTheText("The phone number " + t  +  " was successfully added to the list of numbers for the already existing name "+  s + "\n");
		 } else {
		 gui.setTheText("The name " +  s  +  " and phone number "+  t  + " were successfully added" + "\n");
		 }
	 }
}
